...
- git clone m2_a01w_local_manifests --> .repo/local_manifests (to delete)
- git clone https://github.com/diowil/local_manifests_m2_a01w -b cm-13.0-ZNH5Y .repo/local_manifests
